...
const DEMO_EXPENSE_LEDGER: Record<string, AssetCashflowEntry[]> = {
  "2026-06": [
    ...
    demoExpense("demo-202606-grocery", "2026-06-08", "生鲜与日用品", 12_000, "餐饮", "移动支付"),
    demoExpense("demo-202606-dining", "2026-06-12", "餐厅与外卖", 7_500, "餐饮", "移动支付"),
    demoExpense("demo-202606-transit", "2026-06-14", "通勤与打车", 4_800, "交通", "移动支付"),
    demoExpense("demo-202606-utility", "2026-06-16", "电费燃气与水道", 3_400, "居住"),
    demoExpense("demo-202606-software", "2026-06-18", "ChatGPT 与软件会员", 1_800, "数字服务"),
    demoExpense("demo-202606-fitness", "2026-06-20", "JOYFIT 月费", 2_400, "运动健康"),
    demoExpense("demo-202606-health", "2026-06-21", "门诊与药品", 2_100, "医疗健康"),
    demoExpense("demo-202606-shopping", "2026-06-23", "衣物与家居", 4_000, "购物", "移动支付"),
    demoExpense("demo-202606-social", "2026-06-25", "礼物与聚会", 4_000, "社交"),
    demoExpense("demo-202606-travel", "2026-06-28", "周末短途旅行", 8_000, "旅行"),
  ],
  "2026-07": [
    demoExpense("demo-202607-home", "2026-07-05", "房租与物业", 28_000, "居住"),
    demoExpense("demo-202607-grocery", "2026-07-07", "生鲜与日用品", 12_500, "餐饮", "移动支付"),
    demoExpense("demo-202607-dining", "2026-07-10", "餐厅与外卖", 8_000, "餐饮", "移动支付"),
    demoExpense("demo-202607-transit", "2026-07-12", "通勤与打车", 5_000, "交通", "移动支付"),
    demoExpense("demo-202607-utility", "2026-07-15", "电费燃气与水道", 3_500, "居住"),
    demoExpense("demo-202607-software", "2026-07-17", "ChatGPT 与软件会员", 1_800, "数字服务"),
    demoExpense("demo-202607-fitness", "2026-07-18", "JOYFIT 月费", 2_400, "运动健康"),
    demoExpense("demo-202607-learning", "2026-07-20", "课程与书籍", 4_800, "学习"),
    demoExpense("demo-202607-health", "2026-07-21", "体检与保健", 2_000, "医疗健康"),
    demoExpense("demo-202607-shopping", "2026-07-23", "衣物与家居", 4_000, "购物", "移动支付"),
    demoExpense("demo-202607-social", "2026-07-25", "礼物与聚会", 4_000, "社交"),
    demoExpense("demo-202607-travel", "2026-07-29", "周末短途旅行", 6_000, "旅行"),
  ],
  "2026-08": [
    demoExpense("demo-202608-home", "2026-08-05", "房租与物业", 28_000, "居住"),
    demoExpense("demo-202608-grocery", "2026-08-07", "生鲜买菜", 12_800, "餐饮", "移动支付"),
    demoExpense("demo-202608-dining", "2026-08-09", "餐厅与外卖", 8_600, "餐饮", "移动支付"),
    demoExpense("demo-202608-transit", "2026-08-11", "通勤与打车", 5_200, "交通", "移动支付"),
    demoExpense("demo-202608-learning", "2026-08-13", "课程与书籍", 6_800, "学习"),
    demoExpense("demo-202608-fitness", "2026-08-15", "JOYFIT 月费", 2_400, "运动健康"),
    demoExpense("demo-202608-health", "2026-08-16", "门诊与保健", 1_500, "医疗健康"),
    demoExpense("demo-202608-utility", "2026-08-17", "电费燃气水道与通信", 3_600, "居住"),
    demoExpense("demo-202608-software", "2026-08-18", "ChatGPT 与软件会员", 1_800, "数字服务"),
    demoExpense("demo-202608-travel", "2026-08-20", "周末旅行与酒店", 14_000, "旅行"),
    demoExpense("demo-202608-social", "2026-08-22", "礼物与社交", 4_500, "社交"),
    ...
    demoExpense("demo-202608-culture", "2026-08-25", "电影与展览", 1_400, "文化娱乐", "移动支付"),
    demoExpense("demo-202608-snack", "2026-08-26", "咖啡与零食", 1_000, "餐饮", "移动支付"),
  ],
};
...
const DEMO_CASHFLOW: AssetCashflowData = {
  ...
  months: [
    { month: "2026-06", income: 120_000, expense: 78_000, neutral: 0, balance: 42_000, incomeCount: 1, expenseCount: 11, neutralCount: 0, categories: [{ name: "经营收入", amount: 120_000 }, { name: "居住", amount: -31_400 }, { name: "餐饮", amount: -19_500 }, { name: "旅行", amount: -8_000 }, { name: "其他生活", amount: -19_100 }] },
    { month: "2026-07", income: 135_000, expense: 82_000, neutral: 0, balance: 53_000, incomeCount: 1, expenseCount: 12, neutralCount: 0, categories: [{ name: "经营收入", amount: 135_000 }, { name: "居住", amount: -31_500 }, { name: "餐饮", amount: -20_500 }, { name: "学习", amount: -4_800 }, { name: "其他生活", amount: -25_200 }] },
    { month: "2026-08", income: 168_000, expense: 96_000, neutral: 0, balance: 72_000, incomeCount: 2, expenseCount: 15, neutralCount: 0, categories: [{ name: "经营收入", amount: 138_000 }, { name: "投资分配", amount: 30_000 }, { name: "居住", amount: -31_600 }, { name: "餐饮", amount: -22_400 }, { name: "旅行", amount: -14_000 }, { name: "学习", amount: -6_800 }, { name: "其他生活", amount: -21_200 }] },
  ],
  trend: [
