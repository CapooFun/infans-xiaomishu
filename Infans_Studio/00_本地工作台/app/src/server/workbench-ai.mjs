...
function buildOverviewAiContext(summary) {
  ...
  return {
    ...
    text: [
      ...
      `艺术馆藏：示意书目 ${summary.library?.books ?? 0} 本，已读完 ${summary.library?.completedBooks ?? 0}；得到课 ${summary.library?.courses ?? 0} 门（只公开课名和日期）。开源示例有一篇虚构演示短篇和一份本地虚构电子书单，没有微信读书接口，也没有实时游戏接口。资产页是标明虚构演示的一千万参考账，不是真实账户。`,
