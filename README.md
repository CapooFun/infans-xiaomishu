...
- 一套跑在自己电脑上的网页工作台（手机平板可添加到主屏幕）
- 一套 Mac 窗口壳（源码，不是现成安装包）
- 一套 iPhone／iPad 代码框架（一对一聊天，外加系统分享把图和链接发给秘书；要自己签证）
- 一个 Chrome「发给秘书」扩展（自己加载，不上架）
- 一个只读 MCP，给别的 AI 读你的库
...
![实用工具](readme-images/12-tools-phone.jpg)
